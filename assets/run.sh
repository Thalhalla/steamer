...
/bin/bash ./srcds_run -game csgo -console -usercon +game_type $CS_GAME_TYPE +game_mode $CS_GAME_MODE +mapgroup $CS_MAP_GROUP +map $CS_INITIAL_MAP +sv_setsteamaccount $STEAM_GLST  -port $PORT
